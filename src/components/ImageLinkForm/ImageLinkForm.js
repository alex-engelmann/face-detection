...
const ImageLinkForm = ({ clearURL, onInputChange, onPictureSubmit, oneFace, manyFaces }) => {
    return (
        <div>
            ...
            <p>
                <button className='f5 link dim br3 ph3 pv2 mb2 dib white bg-dark-green' type="submit" onClick={oneFace}>One Face</button>
                <button className='f5 link dim br3 ph3 pv2 mb2 dib white bg-dark-green' type="submit" onClick={manyFaces}>Many Faces</button>
            </p>
